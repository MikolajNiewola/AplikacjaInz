...
import { PlanFillerModal } from './PlanFillerModal'
    ...
    useEffect(() => {
        if (pickedExercisesTemp?.length) {
            setSelectedExercises(prev => {
                ...
                .map(ex => ({ ...ex, reps: ex.reps ?? 5, sets: ex.sets ?? 3, weight: ex.weight ?? '' }));
            ...
            <ScrollView keyboardDismissMode='on-drag'>
                ...
                <View style={styles.sectionHeader}>
                    ...
                    <PlanFillerModal
                        ...
                        maxExercises={9}
                        onAddExercises={(newExercises) => setSelectedExercises(prev => [...prev, ...newExercises])}
                    />
                </View>
                ...
                <TouchableOpacity
                    style={styles.addBtn}
                    onPress={() => navigation.navigate('Select Exercises', {selectedIds: selectedExercises.map(ex => ex.id)})}
                >
